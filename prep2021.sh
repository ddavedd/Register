...
read -p "Set password for mysql with this page as guide"
firefox https://stackoverflow.com/questions/39281594/error-1698-28000-access-denied-for-user-rootlocalhost
